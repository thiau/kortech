...
(function () {
    ...
    module.exports = function (app, upload, ttshelpers, stthelpers, watsonConversation, FileHandler, fs, obj_helper, cloudantFactory, request, photoHelper) {
        require("./partials/watsonHandler")(app, upload, FileHandler, fs, cloudantFactory, watsonConversation);
